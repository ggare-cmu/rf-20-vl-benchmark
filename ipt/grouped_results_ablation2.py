...
default_dict_paper_parts = {
    "Qwen2.5-VL-7B-Instruct": 0.008499947607321345,#Shruti
    "Qwen2.5-VL-7B-Instruct": 0.03757084180854858, #single-class-prompt baseline
}


def groupResults(res, eval_type: str, results_root_dir: str, output_csv_path: str, caption_suffix: str = ""):
    ...
    if len(res) != 20:
        if "paper-parts" not in res:
            ...
            res["paper-parts"] = 0.0
            # res["paper-parts"] = 0.008499947607321345
            # res["paper-parts"] = 0.03757084180854858
            ignore_flag = True
    ...
    print("Saving consolidated results to CSV:", output_csv_path)
...
def consolidate_evaluation_results(eval_type: str, results_root_dir: str, output_csv_path: str):
    ...
    for exp_group_dir in exp_group_dirs:
        ...
        for run_dir in run_dirs:
            ...
            # eval_json_pattern = os.path.join(run_dir, 'evaluations', 'nms0.5', 'evaluation_*.json') #default - implies with no_instructions
            eval_json_pattern = os.path.join(run_dir, 'evaluations', 'vqa_nms0.5', 'evaluation_*.json') #default - implies with no_instructions
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        # default='./results/final_results/rf100vl_IPT_ablations/table2/Qwen2.5-VL-7B-Instruct',
        default='./results/final_results/rf100vl_IPT_ablations/table2/Qwen3-VL-30B-A3B-Instruct',
