...
def rescore_dataset(dataset_name: str, dataset_root: str, results_root: str,
    ...
    combined_detections = []
    model_detections = []  # original model scores from saved predictions
    ...
    for prediction in raw_predictions:
        ...
        # Keep original model detections (for 'model' eval_type)
        for det in parsed:
            model_detections.append({
                "image_id": prediction["img_id"],
                "category_id": cat_name2id.get(det["category_name"], -1),
                "bbox": det["bbox"],
    ...
    detections_by_type = {
        ...
        "new_ranking": new_ranking_detections,
