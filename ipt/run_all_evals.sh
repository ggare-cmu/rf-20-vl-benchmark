...
SESSION_NAME="rf100vl_eval_qwen_singleclas_onIPTs_zeroshot_perClsInstr_fixDetectScale_flashAtt2_vqaWithInstru"
...
# RESULTSDIR="results/rf100vl_zeroshot/rf20_singleclass_codePrompt_vqaScore_nms0.5_perClsInstr"
# CMD_TEMPLATE="rb; python code/rf100vl/qwen-2.5-vl-rf-fsod-master/run_bench_singleclass_VQAscoring_webUI_multimetrics.py --eval --vqa_rescore --apply_nms --nms_threshold 0.5 --output_dir $RESULTSDIR --vqa_batch_size 1"
...
# DATA_INSTR_PATH="results/rf100vl_IPT_zeroshot/rf20_IPT_singleclass_codePrompt_vqaScore_nms0.5_numIters10_perClsInstr_fixDetectScale_flashAtt2/iterative_prompt_refinement/all_refined_class_instructions"
# RESULTSDIR="results/rf100vl_zeroshot_onIPT/rf20_singleclass_onIPT_codePrompt_vqaScore_nms0.5_perClsInstr"
# CMD_TEMPLATE="rb; python code/rf100vl/qwen-2.5-vl-rf-fsod-master/run_bench_singleclass_VQAscoring_webUI_multimetrics.py --eval --vqa_rescore --apply_nms --nms_threshold 0.5 --data_instr_path $DATA_INSTR_PATH --output_dir $RESULTSDIR --vqa_batch_size 1"

DATA_INSTR_PATH="results/rf100vl_IPT_zeroshot/rf20_IPT_singleclass_codePrompt_vqaScore_nms0.5_numIters10_perClsInstr_fixDetectScale_flashAtt2/iterative_prompt_refinement/all_refined_class_instructions"
RESULTSDIR="results/rf100vl_zeroshot_onIPT/rf20_singleclass_onIPT_codePrompt_vqaScore_nms0.5_perClsInstr_vqaWithInstru"
CMD_TEMPLATE="rb; /data3/shared/scripts/vnice/vnice.sh python code/rf100vl/qwen-2.5-vl-rf-fsod-master/run_bench_singleclass_VQAscoring_webUI_multimetrics_vqaWithInstru.py --eval --vqa_rescore --apply_nms --nms_threshold 0.5 --data_instr_path $DATA_INSTR_PATH --output_dir $RESULTSDIR --vqa_batch_size 1"
