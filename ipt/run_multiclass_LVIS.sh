...
RESULTSDIR="results/eccv26/LVIS_baseline/$MODEL_NAME/lvis_baseline_multiclass_rankScore"
...
CMD_TEMPLATE="python3 baseline_evaluate_qwen_local.py --data_dir $DATASET_ROOT --model_name $MODEL_NAME --save_dir $RESULTSDIR --vllm --just_instructions"
