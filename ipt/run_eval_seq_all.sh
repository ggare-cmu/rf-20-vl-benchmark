...
RESULTSDIR="results/eccv26/rf100vl_default/$MODEL_NAME/rf20_IPT_singleclass_rankScore_defaultDataInstr"
CMD_TEMPLATE="python3 ipt/run_bench_singleclass_evaluator.py --model_name $MODEL_NAME --data_instr_path $DATA_INSTR_PATH --rank_rescore --output_dir $RESULTSDIR"
# CMD_TEMPLATE="CUDA_VISIBLE_DEVICES=0,1,2,3 python3 ipt/run_bench_singleclass_evaluator.py --model_name $MODEL_NAME --data_instr_path $DATA_INSTR_PATH --rank_rescore --output_dir $RESULTSDIR"
