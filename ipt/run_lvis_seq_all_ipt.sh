...
RESULTSDIR="results/eccv26/LVIS_IPT/$MODEL_NAME/lvis_IPT_singleclass_rankScore"
CMD_TEMPLATE="python3 ipt/run_bench_singleclass_IPT.py --model_name $MODEL_NAME --ipt_mode --rank_rescore --num_ipt_iterations 10 --root_path $ROOT_DIR --output_dir $RESULTSDIR"
# CMD_TEMPLATE="python3 ipt/run_bench_singleclass_IPT.py --model_name $MODEL_NAME --ipt_mode --rank_rescore --num_ipt_iterations 10 --output_dir $RESULTSDIR"
# CMD_TEMPLATE="CUDA_VISIBLE_DEVICES=4,5,6,7 /data3/shared/scripts/vnice/vnice.sh python3 ipt/run_bench_singleclass_IPT.py --model_name $MODEL_NAME --ipt_mode --rank_rescore --num_ipt_iterations 10 --output_dir $RESULTSDIR"
