...
FEWSHOT_NUMSAMPLES=5

RESULTSDIR="results/eccv26/rf100vl_IPT_ablations/$MODEL_NAME/rf20_IPT_singleclass_rankScore_${FEWSHOT_NUMSAMPLES}shot_samples"
CMD_TEMPLATE="python3 ipt/run_bench_singleclass_IPT.py --model_name $MODEL_NAME --ipt_mode --rank_rescore --num_ipt_iterations 10 --num_samples $FEWSHOT_NUMSAMPLES --output_dir $RESULTSDIR"
# CMD_TEMPLATE="CUDA_VISIBLE_DEVICES=4,5,6,7 /data3/shared/scripts/vnice/vnice.sh python3 ipt/run_bench_singleclass_IPT.py --model_name $MODEL_NAME --ipt_mode --rank_rescore --num_ipt_iterations 10 --num_samples $FEWSHOT_NUMSAMPLES --output_dir $RESULTSDIR"
