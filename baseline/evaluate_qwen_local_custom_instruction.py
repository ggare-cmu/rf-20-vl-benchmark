#Source: https://github.com/shrutijain1405/rf-20-vl-benchmark/blob/main/evaluate_qwen_local.py
...
from baseline.utils.qwen_eval_utils import *
from baseline.utils.shared_eval_utils import *
from baseline.utils.thinking_budget_processor import ThinkingTokenBudgetProcessor
...
def load_qwen_model(model_name, vllm):
    ...
    if(model_name.startswith("Qwen2.5-VL")):
        ...
        model.eval()
    elif(model_name == "Qwen3-VL-2B-Instruct-FP8" or model_name == "Qwen3-VL-235B-A22B-Instruct-FP8" or model_name.startswith("Qwen3-VL-30B-A3B-Instruct") or vllm == True):
        if("FP8" in model_name) or model_name.startswith("Qwen3-VL-30B-A3B-Instruct"):
...
def precompute_prompts_for_dataset_qwen(args, dataset_dir, categories, categories_dict, model_name):
    """
    ...
    prompts = {
        ...
        'instructions': (instructions_system_prompt, None, final_query_text_instructions_standalone, None),
...
def process_dataset(args, model, processor, dataset_dir, few_shot, just_instructions, combined, results_dir, vis_dir, model_name,debug,vllm):
    ...
    prompts = precompute_prompts_for_dataset_qwen(args, dataset_dir, category_names, categories_dict, model_name)
